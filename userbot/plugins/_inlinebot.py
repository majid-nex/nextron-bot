...
async def cmd_list(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/" , "#", "-", "_", "@"):
        ...
        if tgbotusername is None or input_str == "text":
            ...
            if len(string) > 69:
                ...
                with io.BytesIO(str.encode(string)) as out_file:
                    ...
                    await bot.send_file(
                        ...
                        caption="¢σммαη∂ѕ ιη nextron вσт",
            ...
            help_string = f""" Nextron вσт Hᴇʟᴘ ᴘʀᴏᴠɪᴅᴇᴅ ʙʏ тєαм nextron \n
...
@borg.on(admin_cmd(pattern="nextron"))  # pylint:disable=E0602
...
async def _(event):
    ...
    await event.edit("тєℓєтнση  вαѕє∂ υѕєявσт ρσωєяє∂ ву NEXTROM")
