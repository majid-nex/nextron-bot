...
async def cmd_list(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/" , "#", "-", "_", "@"):
        ...
        if tgbotusername is None or input_str == "text":
            ...
            help_string = f""" NEXTRON Hᴇʟᴘ ᴘʀᴏᴠɪᴅᴇᴅ ʙʏ majid\n
...
@borg.on(admin_cmd(pattern="majid"))  # pylint:disable=E0602
...
async def _(event):
    ...
    await event.edit("тєℓєтнση  вαѕє∂ υѕєявσт ρσωєяє∂ ву nextron")
