...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "ŊêxţřǾח Usêr"
USER_BOT_WARN_ZERO = "**You were spamming my sweet master's inbox, henceforth you have been blocked by my master's ŊêxţřǾח.**\n__Now GTFO, i'm busy__"
USER_BOT_NO_WARN = (
    "Hello, This is **ŊêxţřǾח Úl†rã Pr¡va†e Security Protocol⚠️**.\n"
