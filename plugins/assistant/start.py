...
import os
import re
from NEXTRON import PHOTO, ID as id
from telethon import Button, custom, events, functions
import telethon
from telethon.tl.functions.users import GetFullUserRequest
from telethon.utils import pack_bot_file_id
from userbot.uniborgConfig import Config
from NEXTRON import xbot, devs as DEVS
from userbot import bot
from plugins.sql_helper.blacklist_ass import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)

from plugins.sql_helper.bot_users_sql import add_me_in_db, his_userid
