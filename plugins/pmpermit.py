...
from plugins.sql_helper import pmpermit_sql as pmpermit_sql
...
USER_BOT_WARN_ZERO = "**You were spamming my sweet master's inbox, henceforth you have been blocked by my master's Néxtrøn.**\n__Now GTFO, i'm busy__"
USER_BOT_NO_WARN = (
    "Hello, This is **Néxtrøn Úl†rã Pr¡va†e Security Protocol⚠️**.\n"
        ...
        if len(APPROVED_PMs) > 4095:
            with io.BytesIO(str.encode(APPROVED_PMs)) as out_file:
                ...
                await event.client.send_file(
                    ...
                    force_document=True,
                    allow_cache=False,
                    caption="[Nextron]Current Approved PMs",
                    reply_to=event,
                )
                await event.delete()
        else:
