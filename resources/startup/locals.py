...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to Nextron, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    try:
        os.system("git clone https://github.com/majid-nex/nextron-bot && cd Nextron")
    ...
    all_done = "# Nextron Environment Variables.\n# Do not delete this file.\n\n"
    for i in varrs:
        all_done += do_input(i)
    clear_screen()
    print(a)
...
def gen_session():
    print("\nProcessing...")
    os.system("cd nextron && python3 resources/session/ssgen.py")
    return
